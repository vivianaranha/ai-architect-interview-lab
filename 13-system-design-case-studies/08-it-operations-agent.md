# Design an IT Operations Agent

## Interview prompt
Investigate incidents, search runbooks, inspect monitoring, and execute approved remediation.

## Constraints
- 24x7
- Destructive tools possible
- High availability
- Many observability tools
